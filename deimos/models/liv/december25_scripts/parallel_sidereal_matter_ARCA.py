...
if __name__ == "__main__":
    ...
    # ax[0].set_xticklabels([ "%i"%t for t in [ 0, 90, 180, 270] ], fontsize=14)
    # ax[1].set_xticks([ 90, 180, 270])
    # ax[1].set_xticklabels([ "%i"%t for t in [ 90, 180, 270] ], fontsize=14)
    # ax[2].set_xticks([ 90, 180, 270, 360])
    # ax[2].set_xticklabels([ "%i"%t for t in [ 90, 180, 270, 360] ], fontsize=14)
