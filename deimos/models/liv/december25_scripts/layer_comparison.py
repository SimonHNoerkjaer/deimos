...
if __name__ == "__main__" :
    ...
    # # Set SME parameters for all calculators
    # sme_kw = dict(
    #     basis=sme_basis,
    #     a_t_eV=a_eV[0],
    #     a_x_eV=a_eV[1],
    ...
    # box = mpatches.FancyBboxPatch(
    # (x0, y0), x1-x0, y1-y0,
    # boxstyle="square,pad=0.3",  # Standard legend box style
    # edgecolor=legend1.get_frame().get_edgecolor(),
    # facecolor=None,
    # linewidth=legend1.get_frame().get_linewidth(),
    # mutation_aspect=1,
    # zorder=legend1.get_zorder()-1,
    # transform=fig.transFigure
    # )
    ...
    # fig.tight_layout(rect=[0, 0, 1, 0.92])  # Leaves space at the top (8% of figure height)
    # plt.savefig(__file__.replace(".py",".pdf"), bbox_inches='tight')
    # After creating legend1 and legend2
    plt.savefig(
