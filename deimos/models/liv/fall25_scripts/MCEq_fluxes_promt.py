...
# from MCEq.data import prompt_models
...
if __name__ == "__main__":
    ...
    mceq = MCEqRun(
        ...
        prompt_flux_model='BERSS_H3p'
        # prompt_model=prompt_models['BERSS_H3p']
    )
    ...
    plt.savefig("mceq_fluxes_prompt.png")
    ...
    np.savez("mceq_fluxes_prompt.npz", **fluxes)
